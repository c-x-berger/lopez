...
class developer(commands.Cog):
    ...
    @commands.command(
        description="Evaluates arbitrary Python 3 code blocks. Indent with two spaces.",
    ...
    async def devalue(self, ctx: commands.Context, *, source: str):
        ...
        try:
            ...
            em = boiler.embed_template("Result", ctx.me.color)
    ...
    async def source(self, ctx: commands.Context, command: str = None):
        ...
        await ctx.send(
            "{}/{}/#L{}-L{}".format(
                s_url, location, firstline, firstline + len(lines) - 1
            )
        )
